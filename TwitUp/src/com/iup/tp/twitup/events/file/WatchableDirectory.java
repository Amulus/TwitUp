...
public class WatchableDirectory implements IWatchableDirectory {
	 ...
	 */
	protected final Set<File> mPresentFiles;

	/**
	 * Map permettant de stocker les dates de modifications des fichiers.
	 */
	protected final Map<String, Long> mFileModificationMap;
	...
	protected void watchDirectory() {
		if (mDirectory != null) {
			...
			presentFiles.addAll(Arrays.asList(Objects.requireNonNull(mDirectory.listFiles())));
